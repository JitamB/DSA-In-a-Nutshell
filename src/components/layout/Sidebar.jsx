      ...
      <aside className={`sidebar${collapsed ? ' collapsed' : ''}`} aria-label="Module navigation">
        ...
        <div className="sidebar-header">
          <div className="sidebar-brand">
            <span className="sidebar-brand-title">DSA In a Nutshell</span>
            <span className="sidebar-brand-sub">{MODULES.length} Modules</span>
          </div>
        </div>
        ...
        <div className="sidebar-header">
          <div className="sidebar-brand">
            <span className="sidebar-brand-title" style={{color: "#0e569b"}}>
              <a href='https://github.com/JitamB/DSA-In-a-Nutshell/' target='_blank'>Open in Github</a>
            </span>
